    ...
    public class PepScannerDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Alert>(entity =>
            {
                ...
                entity.HasOne(e => e.WatchlistEntry)
                      .WithMany(w => w.Alerts)
                      .HasForeignKey(e => e.WatchlistEntryId)
                      .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<CustomerRelationship>(entity =>
            {
                ...
                entity.HasOne(e => e.RelatedCustomer)
                      .WithMany()
            ...
            // OrganizationWatchlist Configuration
            ...
            // Update Customer Configuration to include OrganizationId
            modelBuilder.Entity<Customer>(entity =>
            {
                entity.HasOne(e => e.Organization)
