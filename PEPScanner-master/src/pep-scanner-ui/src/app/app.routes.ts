...
export const routes: Routes = [
  ...
  // Protected routes
  {
    ...
    children: [
      ...
      { path: 'alerts', loadComponent: () => import('./features/simple-alerts.component').then(m => m.SimpleAlertsComponent) },
      { path: 'alerts/:id', loadComponent: () => import('./features/alerts/alert-detail.component').then(m => m.AlertDetailComponent) },
      { path: 'customers', loadComponent: () => import('./features/simple-customers.component').then(m => m.SimpleCustomersComponent) },
