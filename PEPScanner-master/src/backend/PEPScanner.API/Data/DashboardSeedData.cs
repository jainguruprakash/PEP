            ...
            try
            {
                ...
                if (organization == null)
                {
                    organization = new Organization
                    {
                        ...
                        Name = "Demo Bank Ltd",
                        Code = "DEMO001",
                        Description = "Demo Bank for Testing",
                        Type = "Bank",
                        Industry = "Banking",
                        Country = "India",
                        State = "Maharashtra",
                ...
                foreach (var (firstName, lastName, email, riskLevel) in customerNames)
                {
                    var customer = new Customer
                    {
                        ...
                        LastName = lastName,
                        Email = email,
                        Phone = $"+91-{new Random().Next(700000000, 999999999)}",
                        DateOfBirth = DateTime.UtcNow.AddYears(-new Random().Next(25, 65)),
                        Nationality = "Indian",
                        ...
                        RiskLevel = riskLevel,
                        RiskScore = new Random().Next(1, 100),
